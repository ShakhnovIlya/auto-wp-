...
<section class="benefits">
  <div class="container">
    <div class="benefits__inner">
      <img data-wow-delay="2s" class="benefits__images wow animate__fadeInUp" src="<?php the_field( 'benefits-img' ); ?>">
...
?>
   ...
   <div class="carousel__item">
     <div class="carousel__item-box">
       ...
       <p class="carousel__item-text"><?php the_content(); ?>Экономия 4500 $</p>
     </div>
   </div>
